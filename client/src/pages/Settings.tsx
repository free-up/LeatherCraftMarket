...
export default function Settings() {
  ...
  const handleChange = (field: string, value: any) => {
    ...
    // Изменение значения через точечную нотацию
        ...
        <TabsContent value="appearance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Настройте визуальное отображение</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="cardWidth">Ширина карточки товара</Label>
                <Input
                  id="cardWidth"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="cardHeight">Высота карточки товара</Label>
                <Input
                  id="cardHeight"
                  type="number"
